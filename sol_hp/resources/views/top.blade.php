...
<div class="container bg-white border">
   ...
   <div class="row ">
      <div class="col-sm mx-auto"><img class="d-block mx-auto" style = "width:200px;"src="{{asset('img/icon/phone_iphone_black_24dp.svg')}}" alt="">
         <br>
         <p class="text-center"> アプリ開発</p>
      </div>
      <div class="col-sm"><img class="d-block mx-auto" style = "width:200px;" src="{{asset('img/icon/computer_black_24dp.svg')}}" alt="">
         <p class="text-center"> システム開発　webサイト制作</p>
      </div>
      
      <div class="col-sm"><img class="d-block mx-auto" style = "width:200px;" src="{{asset('img/icon/dns_black_24dp.svg')}}" alt="">
