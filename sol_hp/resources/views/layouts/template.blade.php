    ...
    <footer class="bg-white mt-5 shadow">
      <div>
        <div class="row m-2 pt-3">
          <div class="col m-2 p-2 bg-secondary rounded"><a class="text-light" href="">TELL</a></div>
          <div class="col m-2 p-2 bg-secondary rounded "><a class="text-light" href="">採用情報-Recruit</a></div>
          <div class="col m-2 p-2 bg-secondary rounded "><a class="text-light" href="">個人情報保護方針</a></div>
        </div>
        <div class ="bg-secondary m-3">
          <div class="row m-2 justify-content-center">
            <div class="col-sm "><img src="{{asset('t_head_logo.png')}}" alt=""></div>
            <div class="col-sm bg-light m-3 p-2">
              【大阪本社】<br>
              〒542-0061<br>
